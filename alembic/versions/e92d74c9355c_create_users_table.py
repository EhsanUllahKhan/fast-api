...
def upgrade():
    ...
    op.create_index(op.f('ix_found_items_foundItem_id'), 'found_items', ['foundItem_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_found_items_foundItem_id'), table_name='found_items')
